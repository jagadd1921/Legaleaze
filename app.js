...
var localmongodbUri = 'mongodb://localhost:27017/dev-legaleaze';   
...
var cspPolicy = {
  defaultPolicy: {
   // 'default-src': ["'http://daa2rm9s3wkfy.cloudfront.net/','self'"],
   // 'style-src': ["'http://daa2rm9s3wkfy.cloudfront.net/' 'unsafe-inline' 'self'"],
   // 'script-src': ["'http://maps.googleapis.com/' 'https://secure.payu.in/_payment' 'http://daa2rm9s3wkfy.cloudfront.net/' 'unsafe-eval' 'unsafe-inline' 'self'"],
   // 'img-src': ["'self' data:", 'http://daa2rm9s3wkfy.cloudfront.net/' , 'http://m.c.lnkd.licdn.com/', 'http://*.gstatic.com/', 'http://*.googleapis.com/', 'http://mt0.googleapis.com']  // the day we use the cdn
